...
const account_ThanhHung = {
  username: "755103014",
  password: "Ccc11111,",
  jwtToken: "",
  StudyProgramID: "DHCQK75103",
};

//ultraview
const account_TuanNguyen = {
  username: "755301069",
  password: "Tuan160107",
  jwtToken: "",
  StudyProgramID: "DHCQK75301",
};

//ultraview
const account_HaAnh = {
  username: "755904004",
  password: "27042007abcXYZ*",
  jwtToken: "",
...
const turnIdRequest = {
  name: "TurnID Fetcher",
  account: account_ThanhHung,
  StudyProgramID: account_ThanhHung.StudyProgramID,
};
...
const requests = [
...

  {
    ...
    body: {
      ScheduleStudyUnitAlias: "",
      StudyUnitID: "2611_POLI104",
      CurriculumID: "2611_POLI104_04",
      CurriculumName: "",
    },
  },
  ...
  {
    name: "TuanNguyen",
    account: account_TuanNguyen,
    StudyProgramID: account_TuanNguyen.StudyProgramID,
    body: {
      ScheduleStudyUnitAlias: "",
      StudyUnitID: "2612_BIOL273",
      CurriculumID: "2612_BIOL273_01",
      CurriculumName: "",
    },
  },

  {
    ...
    body: {
      ScheduleStudyUnitAlias: "",
      StudyUnitID: "2612_BIOL274",
      CurriculumID: "2612_BIOL274_01",
      CurriculumName: "",
    },
  },
...

  {
    ...
    body: {
      ...
      CurriculumID: "2611_PHYE250BC_02",
      CurriculumName: "",
    },
  },
  ...
  {
    name: "DoHaAnh",
    account: account_HaAnh,
    StudyProgramID: account_HaAnh.StudyProgramID,
    body: {
      ScheduleStudyUnitAlias: "",
...

  {
    ...
    body: [
      {
        ScheduleStudyUnitAlias: "",
        StudyUnitID: "2611_COMM302",
        CurriculumID: "2611_COMM302_05",
        CurriculumName: "",
      },

      {
        ScheduleStudyUnitAlias: "",
        StudyUnitID: "2611_COMM302",
        CurriculumID: "2611_COMM302_0501",
        CurriculumName: "",
      },
    ],
  },
